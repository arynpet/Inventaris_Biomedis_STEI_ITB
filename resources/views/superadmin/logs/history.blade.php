<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            {{-- Info Data --}}
            <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200 mb-6 flex justify-between items-center">
                <div>
                    <div class="text-xs font-bold text-gray-400 uppercase tracking-wider">Target Data</div>
                    <div class="text-2xl font-bold text-gray-800">{{ class_basename($model) }}</div>
                    <div class="text-sm text-gray-500 font-mono">ID: {{ $id }}</div>
                </div>
                    ...
                    <div class="relative pl-8">
                        ...
                        <div class="bg-white p-5 rounded-lg shadow-md border border-gray-100 hover:shadow-lg transition">
                            <div class="flex justify-between items-start mb-2">
                                ...
                                <div class="text-right">
                                    <div class="text-sm font-bold text-gray-600">{{ $log->created_at->format('d M Y') }}</div>
                            ...
                            @if(!empty($log->properties)) 
                                <div class="mt-4 bg-gray-50 p-3 rounded text-xs font-mono overflow-x-auto border border-gray-200">
