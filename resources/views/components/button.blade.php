...
@php
    ...
    $baseClasses = 'group inline-flex items-center bg-gradient-to-r text-white rounded-xl font-medium shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-200';
    
    // TAMBAHKAN: Tentukan apakah link atau button
    $tag = $href ? 'a' : 'button';
@endphp
