                                ...
                                @forelse ($rooms as $room)
                                    <tr class="hover:bg-blue-50/50 transition-colors duration-150"
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <span
                                                class="inline-flex items-center justify-center px-2.5 py-0.5 rounded-full text-xs font-bold bg-gray-100 text-gray-800 border border-gray-200 font-mono">
                                                {{ $room->code }}
                                            </span>
                                        </td>
                                    ...
                                    <tr>
                                        <td colspan="6" class="px-6 py-12 text-center text-gray-500 bg-gray-50">
                                            <div class="flex flex-col items-center justify-center">
                                                ...
                                                <p class="text-base font-medium text-gray-900">Tidak ada ruangan ditemukan
                                                </p>
                                                <p class="mt-1 text-sm text-gray-500">Sesuaikan filter atau tambah ruangan
                                                    baru.</p>
                                                <a href="{{ route('rooms.create') }}"
                                                    class="mt-4 inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700">Tambah
                                                    Ruangan</a>
                                            </div>
                                        </td>
                                    </tr>
                    ...
                    <div
                        ...
                        <div class="w-full">
                            @if($rooms instanceof \Illuminate\Pagination\LengthAwarePaginator)
                                {{ $rooms->links() }}
                            @else
                                <div class="text-sm text-gray-500">Menampilkan semua {{ $rooms->count() }} data.</div>
                            @endif
                        </div>
                            ...
                            <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                ...
                                <div class="mt-2">
                                    <p class="text-sm text-gray-500">
                                        Apakah Anda yakin ingin menghapus ruangan <span class="font-bold text-gray-800"
