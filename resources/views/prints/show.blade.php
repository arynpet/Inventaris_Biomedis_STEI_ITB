                ...
                <div class="p-8">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                        ...
                        <div class="group p-6 rounded-2xl border-2 border-gray-100 hover:border-purple-200 hover:shadow-lg transition-all duration-300">
                            <div class="flex items-start">
                                ...
                                <div class="flex-1">
                                    <p class="text-xs font-semibold text-gray-500 uppercase tracking-wide mb-2">Operator / User</p>
                                    <p class="text-xl font-bold text-gray-800">{{ $print->user->name ?? 'User Dihapus' }}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="group p-6 rounded-2xl border-2 border-gray-100 hover:border-blue-200 hover:shadow-lg transition-all duration-300">
                            <div class="flex items-start">
                                ...
                                <div class="flex-1">
                                    <p class="text-xs font-semibold text-gray-500 uppercase tracking-wide mb-2">Tanggal Booking</p>
                                    <p class="text-xl font-bold text-gray-800">{{ \Carbon\Carbon::parse($print->date)->translatedFormat('d F Y') }}</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                        ...
                        <div class="group p-5 rounded-2xl border-2 border-gray-100 hover:border-green-200 hover:shadow-lg transition-all duration-300">
                            <div class="flex items-center justify-center flex-col text-center">
                                ...
                                <p class="text-lg font-bold text-gray-800">{{ \Carbon\Carbon::parse($print->start_time)->format('H:i') }}</p>
                            </div>
                        </div>
                        ...
                        <div class="group p-5 rounded-2xl border-2 border-gray-100 hover:border-orange-200 hover:shadow-lg transition-all duration-300">
                            <div class="flex items-center justify-center flex-col text-center">
                                ...
                                <p class="text-lg font-bold text-gray-800">{{ \Carbon\Carbon::parse($print->end_time)->format('H:i') }}</p>
                            </div>
                        </div>
                        ...
                        <div class="group p-5 rounded-2xl border-2 border-cyan-100 bg-gradient-to-br from-cyan-50 to-blue-50 hover:shadow-lg transition-all duration-300">
                            <div class="flex items-center justify-center flex-col text-center">
                                ...
                                <p class="text-2xl font-bold text-cyan-900">{{ $duration }} <span class="text-sm">menit</span></p>
                            </div>
                        </div>
                    ...
                    <div class="p-6 bg-gradient-to-br from-slate-50 to-gray-100 rounded-2xl border-2 border-slate-200 mb-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="bg-white p-4 rounded-xl shadow-sm">
                                <p class="text-xs font-semibold text-gray-500 uppercase tracking-wide mb-1">Nama Mesin</p>
                                <p class="text-base font-bold text-gray-800">
                                    {{ $print->printer->name ?? 'Tidak diketahui' }}
                                </p>
                            </div>
                            <div class="bg-white p-4 rounded-xl shadow-sm">
                                <p class="text-xs font-semibold text-gray-500 uppercase tracking-wide mb-1">Jenis Mesin</p>
                    ...
                    <div class="p-6 bg-gradient-to-br from-amber-50 to-orange-50 rounded-2xl border-2 border-amber-100 mb-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div class="bg-white p-4 rounded-xl shadow-sm">
                                ...
                                <p class="text-base font-bold text-gray-800">{{ $print->material_amount ?? 0 }} {{ $print->material_unit }}</p>
                            </div>
                            <div class="bg-white p-4 rounded-xl shadow-sm">
                                <p class="text-xs font-semibold text-gray-500 uppercase tracking-wide mb-1">Sumber</p>
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-bold bg-amber-100 text-amber-800 uppercase mt-1">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        ...
                        <div class="p-6 bg-white rounded-2xl border-2 border-gray-100 shadow-sm">
                            ...
                            <div class="flex items-center">
                                <span class="inline-flex items-center px-4 py-2.5 {{ $config['bg'] }} {{ $config['text'] }} border-2 {{ $config['border'] }} rounded-xl text-sm font-bold shadow-sm capitalize">
                                    {{ $print->status }}
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="p-6 bg-white rounded-2xl border-2 border-gray-100 shadow-sm">
                            <div class="flex items-center mb-4">
                                ...
                                <p class="text-xs font-semibold text-gray-500 uppercase tracking-wide">File Lampiran (PDF)</p>
                            </div>
                            
                            @if($print->file_path)
                                <a href="{{ route('prints.file', $print->id) }}"
                                   target="_blank"
                                ...
                                <p class="text-xs text-gray-400 mt-2 text-center">{{ $print->file_name }}</p>
                            @else
                                <div class="flex items-center justify-center text-gray-400 py-2 border-2 border-dashed border-gray-200 rounded-xl">
                    ...
                    <div class="p-6 bg-gradient-to-br from-slate-50 to-gray-50 rounded-2xl border-2 border-slate-100">
                        <div class="flex items-start">
                            ...
                            <div class="flex-1">
                                <p class="text-xs font-semibold text-gray-500 uppercase tracking-wide mb-3">Catatan Tambahan</p>
