...
<body class="bg-gray-50 text-gray-900 antialiased">
    ...
    <div class="min-h-screen w-full flex flex-col lg:flex-row">
        ...
        <div class="hidden lg:flex lg:w-1/2 relative bg-indigo-900 items-center justify-center overflow-hidden">
            ...
            <div
                class="absolute top-0 -left-4 w-96 h-96 bg-purple-500 rounded-full mix-blend-multiply filter blur-[100px] opacity-40 animate-blob">
            </div>
            <div
                class="absolute top-0 -right-4 w-96 h-96 bg-indigo-500 rounded-full mix-blend-multiply filter blur-[100px] opacity-40 animate-blob animation-delay-2000">
            </div>
            <div
                class="absolute -bottom-32 left-20 w-96 h-96 bg-blue-500 rounded-full mix-blend-multiply filter blur-[100px] opacity-40 animate-blob animation-delay-4000">
            </div>

            <div class="relative z-10 p-12 text-center max-w-lg">
                <div
                    class="mb-8 inline-flex items-center justify-center w-20 h-20 rounded-2xl bg-white/10 backdrop-blur-lg border border-white/20 shadow-2xl">
                ...
                <h2 class="text-4xl lg:text-5xl font-bold text-white mb-6 heading-font leading-tight">
                    Smart <span
                        class="text-transparent bg-clip-text bg-gradient-to-r from-blue-300 to-purple-300">Inventory</span>
                    <br>Management.
                </h2>

                <p class="text-blue-100/80 text-lg font-light leading-relaxed mb-8">
                    Sistem pemantauan aset biomedis terintegrasi untuk efisiensi laboratorium dan presisi data yang
                    lebih tinggi.
                </p>

                <div class="flex justify-center gap-4">
                    <div
                        class="px-4 py-2 rounded-full bg-white/5 border border-white/10 backdrop-blur-sm text-xs text-blue-200 font-mono">
                        v2.0 Stable
                    </div>
                    <div
                        class="px-4 py-2 rounded-full bg-white/5 border border-white/10 backdrop-blur-sm text-xs text-blue-200 font-mono">
        ...
        <div class="w-full lg:w-1/2 flex items-center justify-center p-6 lg:p-12 relative overflow-y-auto">
            ...
            <div
                class="w-full max-w-md bg-white p-8 lg:p-12 rounded-3xl shadow-[0_30px_60px_-15px_rgba(0,0,0,0.1)] border border-gray-100 animate-fade-in-up">
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-6">
                    ...
                    <div class="animate-fade-in-up delay-200 group">
                        <label for="password"
                            class="block text-sm font-semibold text-gray-700 mb-2 ml-1">Password</label>
                        <div class="relative transition-all duration-300 transform group-focus-within:-translate-y-1">
                            <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                <svg class="h-5 w-5 text-gray-400 group-focus-within:text-indigo-500 transition-colors"
                                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                    ...
                    <div class="flex items-center justify-between animate-fade-in-up delay-300">
                        <label class="flex items-center cursor-pointer group">
                            <div class="relative">
                                ...
                                <div
                                    class="w-5 h-5 border-2 border-gray-300 rounded bg-white transition-all duration-200 group-hover:border-indigo-400">
                                </div>
                                <svg class="w-3 h-3 text-white absolute top-1 left-1 opacity-0 pointer-events-none transition-opacity duration-200"
                        ...
                        @if (Route::has('password.request'))
                            <a class="text-sm font-medium text-indigo-600 hover:text-purple-600 transition-colors duration-200"
                    ...
                    <div class="mt-6 text-center animate-fade-in-up delay-400 pt-4 border-t border-gray-100">
                        <p class="text-xs text-gray-400 mb-2">Ingin meminjam barang?</p>
                        <a href="{{ route('public.catalog') }}"
                            class="inline-flex items-center px-4 py-2 bg-white border border-gray-200 rounded-lg text-sm font-semibold text-gray-700 hover:bg-gray-50 hover:text-indigo-600 transition-colors shadow-sm gap-2">
                            <svg class="w-4 h-4 text-indigo-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z"></path>
                            </svg>
                            Ke Katalog Peminjaman
                        </a>
                    </div>
                </form>
            </div>
            ...
            <div
                class="absolute bottom-4 text-center w-full lg:w-auto text-xs text-gray-400 animate-fade-in-up delay-400">
