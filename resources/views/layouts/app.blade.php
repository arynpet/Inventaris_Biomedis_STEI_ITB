...
<head>
    ...
    <style>
        ...
        #nara-activator {
            display: none;
            /* Default sembunyi, dimunculkan JS */
            position: fixed;
            bottom: 30px;
            right: 30px;
            width: 60px;
        ...
        /* Scrollbar */
        .nara-mode ::-webkit-scrollbar {
            width: 8px;
        }

        .nara-mode ::-webkit-scrollbar-track {
            background: #050f19;
        }

        .nara-mode ::-webkit-scrollbar-thumb {
            background: #1e293b;
        ...
        .nara-mode .sidebar-container a:hover {
            background-color: rgba(0, 243, 255, 0.1) !important;
            color: #fff !important;
        }

        /* Floating Widget Override (Jika muncul di mode Nara) */
        .nara-mode #nara-activator {
...
<body class="antialiased" x-data="{ sidebarOpen: true }">
    ...
    <div id="nara-interface">
        <div class="nara-header"
            style="padding: 12px 15px; background: #f3f4f6; border-bottom: 1px solid #e5e7eb; color: #1f2937; font-weight: bold; display: flex; justify-content: space-between;">
        ...
        <div class="nara-body" id="nara-log"
            style="flex-grow: 1; padding: 15px; overflow-y: auto; display: flex; flex-direction: column; gap: 12px;">
            <div class="ai-msg"
                style="align-self: flex-start; background: #eff6ff; color: #1e40af; padding: 8px 12px; border-radius: 0 10px 10px 10px; max-width: 90%; font-size: 13px; border-left: 3px solid #2563eb;">
                NARA Online. Menunggu perintah.
            </div>
        </div>

        <div class="nara-footer" style="padding: 10px; border-top: 1px solid #e5e7eb; display: flex; gap: 8px;">
            <input type="text" id="nara-input" placeholder="Ketik pesan..." onkeypress="handleEnter(event)"
                style="flex-grow: 1; border: 1px solid #ccc; padding: 8px; border-radius: 4px;">
            <button onclick="sendMessage()" class="btn-send"
                style="background: #2563eb; color: white; border: none; border-radius: 4px; width: 40px; cursor: pointer;">></button>
        </div>
    </div>
