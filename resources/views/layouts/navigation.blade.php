...
<nav x-data="{ open: false }" class="bg-white border-b border-gray-200 fixed top-0 right-0 left-0 z-40">
                    ...
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            <button
                                ...
                                <div
                                    class="w-8 h-8 bg-blue-100 text-blue-600 rounded-lg flex items-center justify-center font-medium text-sm">
                        ...
                        <x-slot name="content">
                            ...
                            <form method="POST" action="{{ route('logout') }}">
                                ...
                                <x-dropdown-link :href="route('logout')"
                                    ...
                                    <div class="flex items-center gap-3">
                                        <i class="fa-solid fa-sign-out-alt w-4 h-4 text-gray-500"></i>
                                        <span>Log Out</span>
                                    </div>
                                </x-dropdown-link>
                            </form>
    ...
    <div x-show="open" x-transition:enter="transition ease-out duration-200"
        ...
        x-transition:leave-end="opacity-0 -translate-y-1" class="sm:hidden border-t border-gray-200 bg-white shadow-lg">
        ...
        <div class="px-4 py-4 bg-gray-50 border-b border-gray-200">
            <div class="flex items-center gap-3">
                <div
                    class="w-10 h-10 bg-blue-100 text-blue-600 rounded-lg flex items-center justify-center font-semibold">
                    {{ strtoupper(substr(Auth::user()->name, 0, 1)) }}
                </div>
                <div>
        ...
        <div class="py-2">
            ...
            <form method="POST" action="{{ route('logout') }}" class="mt-1">
                ...
                <x-responsive-nav-link :href="route('logout')"
                    onclick="event.preventDefault(); this.closest('form').submit();">
                    <div class="flex items-center gap-3">
                        <i class="fa-solid fa-sign-out-alt w-4 h-4"></i>
                        <span>Log Out</span>
                    </div>
                </x-responsive-nav-link>
            </form>
