        ...
        <nav class="flex-1 overflow-y-auto px-3 py-4 space-y-1 custom-scrollbar">
            ...
            <a href="/items" :class="sidebarOpen ? 'justify-start' : 'justify-center'"
                ...
                <div class="relative flex-shrink-0">
                    ...
                    @if (request()->is('items*')) <span
                        class="absolute -top-0.5 -right-0.5 w-2 h-2 {{ $isDash ? 'bg-cyan-400 shadow-[0_0_5px_#00f3ff]' : 'bg-blue-600' }} rounded-full"></span>
                    @endif
                </div>
            ...
            <a href="/rooms" :class="sidebarOpen ? 'justify-start' : 'justify-center'"
                ...
                <div class="relative flex-shrink-0">
                    ...
                    @if (request()->is('rooms*')) <span
                        class="absolute -top-0.5 -right-0.5 w-2 h-2 {{ $isDash ? 'bg-cyan-400' : 'bg-blue-600' }} rounded-full"></span>
                    @endif
                </div>
                ...
                <a href="{{ route('superadmin.users.index') }}" :class="sidebarOpen ? 'justify-start' : 'justify-center'"
                    ...
                    <div class="relative flex-shrink-0">
                        <i data-lucide="shield-check"
                            class="w-5 h-5 {{ $isDash ? 'text-indigo-400' : 'text-indigo-600' }}"></i>
                    </div>
            ...
            <div x-data="{ expanded: false }">
                ...
                <a href="#" x-show="!sidebarOpen"
                    class="flex justify-center px-3 py-2.5 rounded-xl {{ $isDash ? 'text-gray-400 hover:bg-cyan-900/20' : 'text-gray-600 hover:bg-gray-50' }}">
                    <i data-lucide="database" class="w-5 h-5"></i>
                </a>
