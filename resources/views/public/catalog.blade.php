            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                @foreach($items as $item)
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition-shadow duration-300 relative group"
                        ...
                        {{-- Image Area --}}
                        <div class="h-48 bg-gray-50 flex items-center justify-center p-6 group-hover:bg-blue-50/50 transition-colors">
                            {{-- Placeholder Icon (Since we don't have images yet) --}}
                             <svg class="w-16 h-16 text-gray-300 group-hover:text-blue-300 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
